...
function waIcon(phone) {
    ...
    if (phone) {
        return '<a href="' + waLink(phone) + '" target="_blank" title="WhatsApp" onclick="event.stopPropagation()" style="color:#25D366;display:inline-flex;align-items:center;vertical-align:middle;text-decoration:none">' + svg + '</a>';
    }
    return '<span title="Sin teléfono" style="color:var(--muted);opacity:0.35;display:inline-flex;align-items:center;vertical-align:middle">' + svg + '</span>';
}
